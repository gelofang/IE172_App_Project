...
from apps.adopt import adopt, adoptionForm, adoptionForm2, adoptionForm3, adoptionFormComplete
...
def displaypage (pathname):
    ...
    if eventid == 'url':
        if pathname == '/' or pathname == '/home':
            ...
            returnlayout = adoptionForm.layout
        elif pathname == '/adopt/adoptionForm2':
            returnlayout = adoptionForm2.layout
        elif pathname == '/adopt/adoptionForm3':
            returnlayout = adoptionForm3.layout
        elif pathname == '/adopt/adoptionFormComplete':
            returnlayout = adoptionFormComplete.layout
